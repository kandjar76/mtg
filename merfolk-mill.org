...
| 4 | Judge of Currents       | 1W  | 1/1  | merfolk wizard  | When merf becomes tapped: gain 1 life                                                            |
...
| 3 | Fallowsage              | 3U  | 2/2  | merfolk wizard  | When tapped: may draw a card                                                                     |
...
| 4 | Surgespanner            | 2UU | 2/2  | merfolk wizard  | When tapped: u may pay 1U and return tgt perm to its controller hand                             |
|---+-------------------------+-----+------+-----------------+--------------------------------------------------------------------------------------------------|
...
| 7 | Plain           | Basic land                                         |
| 8 | Island          | Basic land                                         |
| 4 | Wanderwine Hub  | Add U or W -- comes tapped unless u show a merfolk |
| 2 | Springleaf Drum | t: tap untapped creat to add 1 mana to pool        |
...
Card to consider:
|   | Memory Sluice             | {ub} | ins     |                | Conspire -- Tgt player put top 4 cards of library to graveyard                                                                                |
...
|   | Sage's Dousing            | 2U   | ins     | wizard         | Counter tgt spell unless controller pays 3, if u control a wizard draw a card                                                                 |
...
|   | Savor the moment          | 1UU  | sorc    |                | Take an extra turn after this one; skip untap step                                                                                            |
|   | Forfend                   | 1W   | inst    |                | Prevent all damage that would be dealt to creat this turn                                                                                     |
|   | Banishing Knack           | U    | inst    |                | Until eot: tgt creat has: t: return tgt non land perm to owner's hand                                                                         |
